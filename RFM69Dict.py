...
config = {
    ...
    "RFM69_REG_03_BITRATE_MSB" : 0x1A, # 2000 bps
    "RFM69_REG_04_BITRATE_LSB" : 0x0B,
    ...
    "RFM69_REG_11_PA_LEVEL" : registers["RF_PALEVEL_PA0_ON"] | registers["RF_PALEVEL_PA1_OFF"] | registers["RF_PALEVEL_PA2_OFF"] | 0x18, # 50mW
    "RFM69_REG_12_PA_RAMP" : registers["RF_PARAMP_40"], # 500us PA ramp-up (1 bit)
    ...
    "RFM69_REG_19_RX_BW" :       registers["RF_RXBW_DCCFREQ_010"] | registers["RF_RXBW_MANT_24"] | registers["RF_RXBW_EXP_5"], # Rx Bandwidth: 128KHz
    "RFM69_REG_1E_AFC_FEI" :     registers["RF_AFCFEI_AFCAUTO_OFF"] | registers["RF_AFCFEI_AFCAUTOCLEAR_OFF"], # Automatic AFC on, clear after each packet
    ...
    "RFM69_REG_3C_FIFO_THRESHOLD" : registers["RF_FIFOTHRESH_TXSTART_FIFONOTEMPTY"] | 0x0F, #TX on FIFO not empty
